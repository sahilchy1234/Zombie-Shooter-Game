...
using System.Text;
using AuroraFPSRuntime.Utilities.FullSerializer.Internal;

namespace AuroraFPSRuntime.Utilities.FullSerializer {
    /// <summary>
    ...
    public class fsAotCompilationManager {
        ...
        private static string GenerateDirectConverterForTypeInCSharp(Type type, fsMetaProperty[] members, bool isConstructorPublic) {
            ...
            sb.AppendLine();
            sb.AppendLine("namespace AuroraFPSRuntime.Utilities.FullSerializer {");
            ...
            sb.AppendLine("}");
            sb.AppendLine();
            sb.AppendLine("namespace AuroraFPSRuntime.Utilities.FullSerializer.Speedup {");
